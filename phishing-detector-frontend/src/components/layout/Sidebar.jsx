...
import { Home, Mail, User, Clock, Star, LogOut, Shield, ChevronLeft, ChevronRight } from 'lucide-react';
import './Sidebar.css';
  ...
  return (
    ...
    <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''} ${isMobileOpen ? 'open' : ''}`}>
      <div className="sidebar-header">
        ...
        {/* 4. เพิ่มปุ่ม Toggle สำหรับ Desktop กลับเข้ามา */}
      ...
      <div className="sidebar-footer">
        <button className="logout-btn" onClick={handleLogout} title={isCollapsed ? 'ออกจากระบบ' : ''}>
          <LogOut size={20} />
